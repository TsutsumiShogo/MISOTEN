...
public class charSelect : MonoBehaviour {
    ...
    [SerializeField]
    private GameObject[] m_desideObj = new GameObject[3];
	...
	public void Init () {
        ...
        switch (m_selectNo){
            case 0:
                ...
                m_desideObj[0].transform.localPosition = new Vector3(0.0f, m_desideObj[0].transform.localPosition.y, m_desideObj[0].transform.localPosition.z);
                ...
                m_desideObj[2].transform.localPosition = new Vector3(4.6f, m_desideObj[2].transform.localPosition.y, m_desideObj[2].transform.localPosition.z);
                break;
            case 1:
                ...
                m_desideObj[0].transform.localPosition = new Vector3(4.6f, m_desideObj[0].transform.localPosition.y, m_desideObj[0].transform.localPosition.z);
                m_desideObj[1].transform.localPosition = new Vector3(0.0f, m_desideObj[1].transform.localPosition.y, m_desideObj[1].transform.localPosition.z);
                m_desideObj[2].transform.localPosition = new Vector3(-4.6f, m_desideObj[2].transform.localPosition.y, m_desideObj[2].transform.localPosition.z);
                break;
            case 2:
    ...
    private void MoveAction(){
        ...
        if (moveLeft){
            for(int i= 0; i<3;i++){
                ...
                m_desideObj[i].transform.localPosition = new Vector3(m_desideObj[i].transform.localPosition.x + (4.6f * Time.deltaTime / m_moveTime), m_desideObj[i].transform.localPosition.y, m_desideObj[i].transform.localPosition.z);
            }
            if (m_char[m_selectNo].transform.localPosition.x <= m_default[1].x)
            {
                ...
                m_desideObj[m_selectNo].transform.localPosition = new Vector3(0.0f, m_desideObj[m_selectNo].transform.localPosition.y, m_desideObj[m_selectNo].transform.localPosition.z);
        ...
        if (moveRight){
            for (int i = 0; i < 3; i++){
                m_char[i].transform.localPosition = new Vector3(m_char[i].transform.localPosition.x + ((m_default[2].x - m_default[1].x) * Time.deltaTime / m_moveTime), m_char[i].transform.localPosition.y, m_char[i].transform.localPosition.z);
                m_desideObj[i].transform.localPosition = new Vector3(m_desideObj[i].transform.localPosition.x - (4.4f * Time.deltaTime / m_moveTime), m_desideObj[i].transform.localPosition.y, m_desideObj[i].transform.localPosition.z);
            }
            if (m_char[m_selectNo].transform.localPosition.x >= m_default[1].x){
                SetPosition();
                m_char[m_selectNo].transform.localPosition = new Vector3(m_default[1].x, m_char[m_selectNo].transform.localPosition.y, m_char[m_selectNo].transform.localPosition.z);
