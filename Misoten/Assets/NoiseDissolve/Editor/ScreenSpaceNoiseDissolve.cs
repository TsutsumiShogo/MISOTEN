...
public class ScreenSpaceNoiseDissolve : MaterialEditor
{
	Material material {
		get {
	...
	void DrawPropertys ()
	{
		...
		// Dissolve
		float dissolveDepth = EditorGUILayout.Slider ("DissolveDepth", material.GetFloat ("_DissolveDepth"), 0, 1);
		float dissolveSize = EditorGUILayout.Slider ("DissolveSize", material.GetFloat ("_DissolveSize"), 0, 1);
		...
		if (EditorGUI.EndChangeCheck ()) {
			...
			// Dissolve
			material.SetFloat ("_DissolveDepth", dissolveDepth);
			material.SetFloat ("_DissolveSize", dissolveSize);
