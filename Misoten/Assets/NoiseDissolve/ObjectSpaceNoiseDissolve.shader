Shader "Custom/ObjectSpaceNoiseDissolve" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			noise = noise - _DissolvePercentage;

			// RimLight
			float rim = lerp(0, _RimSize, _DissolvePercentage);
			if(noise < rim){
	...
	FallBack "Diffuse"
	CustomEditor "ObjectSpaceNoiseDissolve"
}
